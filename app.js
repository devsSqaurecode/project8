...
function sendMail() {
    ...
    if (name === "" || email === "" || mobile === "" || location === "" || product === "" || turnover === "" || numberOfEmployees === "" || engagedManufacturing === "" || patent === "" || collab === "" || priority === "" || source === "" || budget === "" || collabInitiation === "" || majorChallenge === "" || expectation === "" || benefit === "") {
